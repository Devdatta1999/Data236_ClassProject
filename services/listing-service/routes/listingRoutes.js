...
router.delete('/flights/:flightId', authenticate, requireAdmin, flightController.deleteFlight);
...
router.delete('/hotels/:hotelId', authenticate, requireAdmin, hotelController.deleteHotel);
...
router.delete('/cars/:carId', authenticate, requireAdmin, carController.deleteCar);
